...
glyphicon glyphicon-check"></span> Tambah Data MABA</a>
        <input id="cari" style="margin-left:10px; width: 75%; float: left" name="cari" type="text" class="form-control" placeholder="Cari Data MABA">
  ...
  <table class="table table-bordered table-responsive">
    ...
    <tbody>
      ...
      @foreach ($result as $datamahasiswa)
        {{-- expr --}}
        <tr>
